...
urlpatterns = [
    ...
    re_path(r'^lettering-item-categories/$', LetteringItemCategoryListView.as_view(), name='lettering-item-categories-api'),
    ...
    re_path(r'^product-variation-retrieve/(?P<id>[0-9]+)/$', ProductVariationRetrieveView.as_view(), name='product-category-api'),
